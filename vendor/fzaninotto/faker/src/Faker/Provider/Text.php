...
abstract class Text extends Base
{
     ...
     * generates a weighted table with the specified number of words as the front and the
     ...
     *                             generated text usually doesn't make sense. Higher front sizes (up to 5)
